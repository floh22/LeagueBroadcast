...
namespace LeagueBroadcastHub.State.Client
{
    class Converter
    {
        ...
        public static string ConvertStateName(List<Data.Client.LCU.Action> actions)
        {
        ...
        public static StateConversionOutput ConvertState(CurrentState state)
        {
            ...
            var flattenedActions = new List<Data.Client.LCU.Action>();
        ...
        public class ConversionInput
        {
            ...
            public List<Data.Client.LCU.Action> actions;

            public ConversionInput(List<Cell> team, List<Data.Client.LCU.Action> actions)
            {
                this.team = team;
