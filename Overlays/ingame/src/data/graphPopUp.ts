...
export default class GraphPopUp {
    ...
    constructor(scene, data: GoldEntry[]) {
        ...
        this.title = scene.add.text(850, 850, 'GOLD DIFFERENCE OVER TIME', {
                ...
                scales: {
                    ...
                    yAxes: [{
                        ...
                        ticks: {
                            ...
                            callback: function (value, index, values) {
                                if (index === values.length - 1) return FormatGold(Math.min.apply(this, values));
                                else if (index === 0) return FormatGold(Math.max.apply(this, values));
...
var ColorPlugin = {
    beforeRender: function (x, options) {
        ...
        gradientFill.addColorStop(yPos / c.height - 0.01, blueRGB);
        gradientFill.addColorStop(yPos / c.height + 0.01, redRGB);
