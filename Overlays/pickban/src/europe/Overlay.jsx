...
import logo from '../assets/LOLLHU.png';
                ...
                {Object.keys(state).length !== 0 &&
                    <div className={cx(css.ChampSelect)}>
                        ...
                        <div className={cx(css.MiddleBox)}>
                            <div className={cx(css.BanPickPhase)}>
                                {state.state}
                            </div>
                            ...
                            <div className={cx(css.Patch)}>
                                PATCH {String(config.frontend.patch).split(".").slice(0, -1).join(".")}
                            </div>
                            <div className={cx(css.Timer, {
                                ...
                                {state.timer < 10 && <div className={cx(css.TimerChars)}>
                                    <div key={`div-0`}className={cx(css.TimerChar)}>0</div>
                                    <div key={`div-1`}className={cx(css.TimerChar)}>{state.timer}</div>
                                </div>}
                                {state.timer < 100 && state.timer >= 10 && <div className={cx(css.TimerChars)}>
